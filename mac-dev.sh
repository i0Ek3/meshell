...
install_pkg() {
	pkg=("tmux" "tree" "bensadeh/circumflex/circumflex" "neovim" "tig" "git-extras" "mysql" "yarn" "mycli" "pgcli" "redis" "shellcheck" "iproute2mac" "screenfetch" "neofetch" "telnet" "gawk" "ack" "automake" "llvm" "wget" "mpg123" "youtube-dl" "ffmpeg" "xquartz" "bash-completion" "docker-completion" "nvm" "scc" "cloc" "protobuf" "minikube" "kubectl" "graphviz" "qlmarkdown" "syntax-highlight")
